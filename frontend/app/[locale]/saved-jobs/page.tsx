                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-primary-100">{savedJobs.length} {t('subtitle')}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 max-w-4xl py-12">
                ...
                {savedJobs.length === 0 ? (
                    <div className="card p-12 text-center">
                        ...
                        <h3 className="text-xl font-semibold mb-2">{t('noSavedJobs')}</h3>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-3 mt-2 text-sm text-gray-500">
                                                ...
                                                <span className="flex items-center gap-1">
                                                    ...
                                                    {t('savedAt')} {new Date(saved.savedAt).toLocaleDateString(locale === 'ar' ? 'ar-EG' : 'en-US')}
                                                </span>
                                            </div>
                                            {saved.jobId.salaryMin && saved.jobId.salaryMax && (
                                                <p className="text-primary-600 font-semibold mt-2">
                                                    {saved.jobId.salaryMin.toLocaleString()} - {saved.jobId.salaryMax.toLocaleString()} {tj('salary')}
                                                </p>
                                            )}
                                        </div>
                                    </div>
