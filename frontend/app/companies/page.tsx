...
export default function CompaniesPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            {/* Header */}
            <div className="bg-gradient-to-br from-secondary-600 to-secondary-800 text-white pb-12 pt-32">
                <div className="container mx-auto px-4">
                    <h1 className="text-3xl font-bold mb-4">اكتشف أفضل الشركات</h1>
                    <p className="text-secondary-100 mb-8">تعرف على ثقافة العمل وفرص التوظيف في كبرى الشركات</p>
                    ...
                    <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-3 max-w-3xl">
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                className="w-full pr-12 pl-4 py-4 rounded-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-secondary-500"
                            />
                        </div>
                        <div className="md:w-64 relative">
                            ...
                            <select
                                ...
                                className="w-full pr-12 pl-4 py-4 rounded-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-secondary-500 appearance-none bg-white"
                            >
                                    ...
                                    <div className="card hover:shadow-xl transition-all h-full flex flex-col">
                                        <div className="p-6">
                                            ...
                                            <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
                                                ...
                                                <span>{company.location || 'غير محدد'}</span>
                                            </div>
                                            <p className="text-gray-600 line-clamp-3 text-sm mb-4">
                                                {company.description}
                                            </p>
                                        </div>
                                        <div className="mt-auto border-t bg-gray-50 p-4 flex items-center justify-between text-sm">
